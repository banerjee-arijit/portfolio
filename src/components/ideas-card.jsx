...
const ideas = [
  {
    ...
    description:
      "An autonomous orchestration platform where developers specify goals, and a crew of cooperating AI agents collaborate to generate, test, and compile full-stack React and Java modules.",
    gradient:
      "from-purple-500/10 to-indigo-500/10 dark:from-purple-950/20 dark:to-indigo-950/20",
  },
  {
    ...
    description:
      "A lightweight cloud agent that intercepts code submissions, runs automated static analyses, drafts context-aware refactoring tips, and flags potential security vulnerabilities.",
    gradient:
      "from-blue-500/10 to-cyan-500/10 dark:from-blue-950/20 dark:to-cyan-950/20",
  },
  {
    ...
    description:
      "A real-time whiteboard canvas supporting vector drawing, sticky notes, active cursor tracking, and presence syncing, optimized with CRDTs to guarantee zero merge conflicts.",
    gradient:
  ...
  },
  {
    ...
    description:
      "A dashboard showing EVM chain transaction logs, calculating smart contract gas utilization patterns, and detailing optimized, lower-cost contract calling options.",
    gradient:
  ...
  return (
    <div className="mt-8 px-4 md:px-6">
      ...
      <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-6 leading-relaxed">
        Innovative concepts I am researching, designing, and preparing to build
        next.
      </p>
          ...
          >
            <div>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <idea.icon
                  className="text-neutral-500 dark:text-neutral-400 group-hover:scale-110 transition-transform duration-300"
                  size={18}
                />
              </div>
